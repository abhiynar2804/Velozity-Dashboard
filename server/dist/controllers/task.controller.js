...
class TaskController {
    ...
    async createTask(req, res, next) {
        try {
            ...
            res.status(201).json(ApiResponse_1.ApiResponse.success('Task created successfully', task, 201));
        }
        catch (error) {
            if (error instanceof auth_service_1.AppError) {
                res.status(error.statusCode).json(ApiResponse_1.ApiResponse.error(error.message, error.statusCode));
    ...
    async getTaskById(req, res, next) {
        try {
            ...
            res.status(200).json(ApiResponse_1.ApiResponse.success('Task fetched successfully', task));
        }
        catch (error) {
            if (error instanceof auth_service_1.AppError) {
                res.status(error.statusCode).json(ApiResponse_1.ApiResponse.error(error.message, error.statusCode));
    ...
    async updateTask(req, res, next) {
        try {
            ...
            res.status(200).json(ApiResponse_1.ApiResponse.success('Task updated successfully', task));
        }
        catch (error) {
            if (error instanceof auth_service_1.AppError) {
                res.status(error.statusCode).json(ApiResponse_1.ApiResponse.error(error.message, error.statusCode));
    ...
    async deleteTask(req, res, next) {
        try {
            ...
            res.status(200).json(ApiResponse_1.ApiResponse.success('Task deleted successfully', null));
        }
        catch (error) {
            if (error instanceof auth_service_1.AppError) {
                res.status(error.statusCode).json(ApiResponse_1.ApiResponse.error(error.message, error.statusCode));
