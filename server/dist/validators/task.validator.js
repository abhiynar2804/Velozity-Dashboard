...
exports.createTaskSchema = zod_1.z.object({
    ...
    assignedDeveloperId: zod_1.z.string().cuid('Developer ID must be a valid CUID').optional().nullable(),
...
exports.taskQuerySchema = zod_1.z.object({
    ...
    status: zod_1.z.nativeEnum(client_1.TaskStatus).optional(),
    priority: zod_1.z.nativeEnum(client_1.TaskPriority).optional(),
    from: zod_1.z.string().refine((value) => !Number.isNaN(Date.parse(value)), 'From must be a valid date').optional(),
    to: zod_1.z.string().refine((value) => !Number.isNaN(Date.parse(value)), 'To must be a valid date').optional(),
